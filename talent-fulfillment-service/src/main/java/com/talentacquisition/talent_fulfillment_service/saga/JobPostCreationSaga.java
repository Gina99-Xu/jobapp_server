package com.talentacquisition.talent_fulfillment_service.saga;
...
public class JobPostCreationSaga {
    ...
    public void handle(JobPostCreatedEvent jobPostCreatedEvent) {
        UpdateTalentRequestStatusCommand updateTalentRequestStatusCommand = UpdateTalentRequestStatusCommand
                .builder().talentRequestId(jobPostCreatedEvent.getTalentRequestId())
